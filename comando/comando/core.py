...
""")
    ...
    def declare_state(self, var, rate_of_change=None, init_state=None,
        ...
        if not isinstance(init_state, comando.Expr):
            if init_state is not comando.cyclic:
    ...
    def make_state(self, name, rate_of_change=None, init_state=None,
...
class DataProxy(comando.SlotSerializationMixin):
    ...
    def __getattr__(self, attr):
        """Defer all attribute access to the obect returned by the getter."""
        return getattr(self.getter(), attr)

    def __eq__(self, other):
        """Explicitly defer comparioson."""
